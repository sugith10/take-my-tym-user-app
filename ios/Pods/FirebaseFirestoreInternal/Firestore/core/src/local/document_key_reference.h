...
#ifndef FIRESTORE_CORE_SRC_LOCAL_DOCUMENT_KEY_REFERENCE_H_
#define FIRESTORE_CORE_SRC_LOCAL_DOCUMENT_KEY_REFERENCE_H_
...
#endif  // FIRESTORE_CORE_SRC_LOCAL_DOCUMENT_KEY_REFERENCE_H_

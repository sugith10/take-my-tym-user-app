...
#ifndef FIRESTORE_CORE_SRC_LOCAL_LOCAL_WRITE_RESULT_H_
#define FIRESTORE_CORE_SRC_LOCAL_LOCAL_WRITE_RESULT_H_
...
#endif  // FIRESTORE_CORE_SRC_LOCAL_LOCAL_WRITE_RESULT_H_

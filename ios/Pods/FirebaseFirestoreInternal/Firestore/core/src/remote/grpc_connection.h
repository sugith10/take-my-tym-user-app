...
#ifndef FIRESTORE_CORE_SRC_REMOTE_GRPC_CONNECTION_H_
#define FIRESTORE_CORE_SRC_REMOTE_GRPC_CONNECTION_H_
...
#endif  // FIRESTORE_CORE_SRC_REMOTE_GRPC_CONNECTION_H_

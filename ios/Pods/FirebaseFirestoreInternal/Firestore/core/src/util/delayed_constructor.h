...
#ifndef FIRESTORE_CORE_SRC_UTIL_DELAYED_CONSTRUCTOR_H_
#define FIRESTORE_CORE_SRC_UTIL_DELAYED_CONSTRUCTOR_H_
...
#endif  // FIRESTORE_CORE_SRC_UTIL_DELAYED_CONSTRUCTOR_H_

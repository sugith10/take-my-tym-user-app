...
#ifndef ENVOY_TYPE_HTTP_V3_COOKIE_PROTO_UPB_MINITABLE_H_
#define ENVOY_TYPE_HTTP_V3_COOKIE_PROTO_UPB_MINITABLE_H_
...
#endif  /* ENVOY_TYPE_HTTP_V3_COOKIE_PROTO_UPB_MINITABLE_H_ */

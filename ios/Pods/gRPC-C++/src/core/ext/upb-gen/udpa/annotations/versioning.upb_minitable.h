...
#ifndef UDPA_ANNOTATIONS_VERSIONING_PROTO_UPB_MINITABLE_H_
#define UDPA_ANNOTATIONS_VERSIONING_PROTO_UPB_MINITABLE_H_
...
#endif  /* UDPA_ANNOTATIONS_VERSIONING_PROTO_UPB_MINITABLE_H_ */

...
static const upb_MiniTableSub envoy_config_listener_v3_Listener_submsgs[24] = {
  {.submsg = &envoy__config__core__v3__Address_msg_init},
  {.submsg = &envoy__config__listener__v3__FilterChain_msg_init},
  ...
  {.submsg = &envoy__config__listener__v3__ListenerFilter_msg_init},
  {.submsg = &google__protobuf__BoolValue_msg_init},
  {.submsg = &google__protobuf__BoolValue_msg_init},
  {.submsg = &google__protobuf__UInt32Value_msg_init},
  {.submsg = &envoy__config__core__v3__SocketOption_msg_init},
  {.submsg = &google__protobuf__Duration_msg_init},
  {.submsg = &envoy__config__listener__v3__UdpListenerConfig_msg_init},
  {.submsg = &envoy__config__listener__v3__ApiListener_msg_init},
  {.submsg = &envoy__config__listener__v3__Listener__ConnectionBalanceConfig_msg_init},
  {.submsg = &envoy__config__accesslog__v3__AccessLog_msg_init},
  {.submsg = &google__protobuf__UInt32Value_msg_init},
  {.submsg = &envoy__config__listener__v3__FilterChain_msg_init},
  {.submsg = &google__protobuf__BoolValue_msg_init},
  {.submsg = &envoy__config__listener__v3__Listener__InternalListenerConfig_msg_init},
  {.submsg = &google__protobuf__BoolValue_msg_init},
  {.submsg = &xds__type__matcher__v3__Matcher_msg_init},
  {.submsg = &envoy__config__listener__v3__AdditionalAddress_msg_init},
  {.submsg = &google__protobuf__UInt32Value_msg_init},
};

static const upb_MiniTableField envoy_config_listener_v3_Listener__fields[32] = {
  {1, UPB_SIZE(124, 24), 0, kUpb_NoSub, 9, (int)kUpb_FieldMode_Scalar | ((int)kUpb_FieldRep_StringView << kUpb_FieldRep_Shift)},
  ...
  {27, UPB_SIZE(120, 240), UPB_SIZE(-97, -17), 19, 11, (int)kUpb_FieldMode_Scalar | ((int)UPB_SIZE(kUpb_FieldRep_4Byte, kUpb_FieldRep_8Byte) << kUpb_FieldRep_Shift)},
  {28, UPB_SIZE(132, 192), 0, kUpb_NoSub, 9, (int)kUpb_FieldMode_Scalar | ((int)kUpb_FieldRep_StringView << kUpb_FieldRep_Shift)},
  ...
  {34, UPB_SIZE(116, 232), 18, 23, 11, (int)kUpb_FieldMode_Scalar | ((int)UPB_SIZE(kUpb_FieldRep_4Byte, kUpb_FieldRep_8Byte) << kUpb_FieldRep_Shift)},
};
...
const upb_MiniTable envoy__config__listener__v3__Listener_msg_init = {
  ...
  UPB_SIZE(144, 248), 32, kUpb_ExtMode_NonExtendable, 13, UPB_FASTTABLE_MASK(248), 0,
  UPB_FASTTABLE_INIT({
    {0x0000000000000000, &_upb_FastDecoder_DecodeGeneric},
    ...
    {0x00f000101b1301da, &upb_pom_2bt_max64b},
...
static const upb_MiniTableSub envoy_config_listener_v3_Listener_ConnectionBalanceConfig_submsgs[2] = {
  {.submsg = &envoy__config__listener__v3__Listener__ConnectionBalanceConfig__ExactBalance_msg_init},

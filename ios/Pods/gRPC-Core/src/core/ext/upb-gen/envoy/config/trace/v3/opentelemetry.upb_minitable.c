...
static const upb_MiniTableSub envoy_config_trace_v3_OpenTelemetryConfig_submsgs[4] = {
  ...
  {.submsg = &envoy__config__core__v3__HttpService_msg_init},
...
static const upb_MiniTableField envoy_config_trace_v3_OpenTelemetryConfig__fields[5] = {
  ...
  {5, UPB_SIZE(16, 48), 3, 3, 11, (int)kUpb_FieldMode_Scalar | ((int)UPB_SIZE(kUpb_FieldRep_4Byte, kUpb_FieldRep_8Byte) << kUpb_FieldRep_Shift)},
};
...
const upb_MiniTable envoy__config__trace__v3__OpenTelemetryConfig_msg_init = {
  ...
  UPB_FASTTABLE_INIT({
    ...
    {0x003000000303002a, &upb_psm_1bt_maxmaxb},
    {0x0000000000000000, &_upb_FastDecoder_DecodeGeneric},
    {0x0000000000000000, &_upb_FastDecoder_DecodeGeneric},
  })
};

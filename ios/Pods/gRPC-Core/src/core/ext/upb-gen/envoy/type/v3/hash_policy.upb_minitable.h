...
#ifndef ENVOY_TYPE_V3_HASH_POLICY_PROTO_UPB_MINITABLE_H_
#define ENVOY_TYPE_V3_HASH_POLICY_PROTO_UPB_MINITABLE_H_
...
#endif  /* ENVOY_TYPE_V3_HASH_POLICY_PROTO_UPB_MINITABLE_H_ */

...
static const upb_MiniTableSub google_api_expr_v1alpha1_Type_submsgs[7] = {
  ...
  {.submsg = &google__api__expr__v1alpha1__Type__ListType_msg_init},
  {.submsg = &google__api__expr__v1alpha1__Type__MapType_msg_init},
  {.submsg = &google__api__expr__v1alpha1__Type__FunctionType_msg_init},
  {.submsg = &google__api__expr__v1alpha1__Type_msg_init},
  {.submsg = &google__protobuf__Empty_msg_init},
  {.submsg = &google__api__expr__v1alpha1__Type__AbstractType_msg_init},
};
...
static const upb_MiniTableSub google_api_expr_v1alpha1_Decl_submsgs[2] = {
  {.submsg = &google__api__expr__v1alpha1__Decl__IdentDecl_msg_init},
